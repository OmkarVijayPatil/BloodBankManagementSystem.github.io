                ...
                <?php 
                    ...
                    while($row = mysqli_fetch_assoc($query_run)){
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-sm " href="accept_don.php?did=<?php echo $row['id']; ?>&bg=<?php echo $bg; ?>&nu=<?php echo $row['no_units'];?>" style="background-color: #b6dc35;">Approve</a>
                            <a class="btn btn-sm " href="reject_don.php?did=<?php echo $row['id']; ?>"style="background-color: #ff6a00;">Reject</a></td>
                        </tr>
                        <?php
                        }
                        $sno++;
