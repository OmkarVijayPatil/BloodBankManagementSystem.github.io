    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="form-group">
                ...
                <input type="submit" class="btn " value="Update" name="update_patient" style="background:linear-gradient(to right, rgb(0, 176, 155), rgb(150, 201, 61))"; border: linear-gradient(to right, rgb(0, 176, 155), rgb(150, 201, 61));">
            </form>
            </div>
        </div>
    </div>
