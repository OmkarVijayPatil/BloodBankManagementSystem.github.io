...
<body>
    <div class="row" style="margin-top: 4%;">
        ...
        <center><h4>Blood Donation Form</h4></center><hr><br></hr>
        <form action="" method="post">
            ...
            <input type="submit" class="btn " name="donate_submit" value="Submit" style="background: linear-gradient(to right, rgb(0, 176, 155), rgb(150, 201, 61));"; border:linear-gradient(to right, rgb(0, 176, 155), rgb(150, 201, 61));">
        </form>
        </div>
        <div class="col-md-6 m-auto">
            <img src="../images/donation.jpg" class="img-fluid" style="border-radius:3%; width: 500px; height: auto;">
        </div>
    </div>
</body>
</html>
