...
<nav class="navbar navbar-expand-lg navbar-dark " style="background: linear-gradient(to right, rgb(0, 176, 155), rgb(150, 201, 61));">
    ...
    <div class="container-fluid">
        ...
        <div class="col-xs-1 card" style="margin-top:125px; margin-left: 85px;border-radius: 30px; background: linear-gradient(to right, rgb(97, 97, 97), rgb(155, 197, 195));">
                <h5 style="color:#E21717">Blood Requested</h5>
                <b style="color:linear-gradient(to right, rgb(218, 210, 153), rgb(176, 218, 185));">Total: <?php echo $blood_requested; ?> Units</b>
            </div>
            ...
            <div class="col-xs-1 card" style="margin-top: 125px;border-radius: 30px;background: linear-gradient(to right, rgb(97, 97, 97), rgb(155, 197, 195));">
                <h5 style="color:#E21717">Total Requests</h5>
                <b style="color:linear-gradient(to right, rgb(218, 210, 153), rgb(176, 218, 185));">Total: <?php echo $total_request; ?></b>
            </div>

            <div class="col-xs-1 card" style="margin-top: 125px;border-radius: 30px;background: linear-gradient(to right, rgb(97, 97, 97), rgb(155, 197, 195));">
                <h5 style="color:#E21717">Request Pending</h5>
                <b style="color:linear-gradient(to right, rgb(218, 210, 153), rgb(176, 218, 185));">Total: <?php echo $total_request - $request_acc - $request_rej; ?></b>
            </div>

            <div class="col-xs-1 card" style="margin-top: 125px;border-radius: 30px;background:linear-gradient(to right, rgb(97, 97, 97), rgb(155, 197, 195));">
                <h5 style="color:#E21717">Request Accepted</h5>
                <b style="color:linear-gradient(to right, rgb(218, 210, 153), rgb(176, 218, 185));">Total: <?php echo $request_acc; ?></b>
            </div>

            <div class="col-xs-1 card" style="margin-top: 125px;border-radius: 30px;background: linear-gradient(to right, rgb(97, 97, 97), rgb(155, 197, 195));">
                <h5 style="color:#E21717">Request Rejected</h5>
                <b style="color:linear-gradient(to right, rgb(218, 210, 153), rgb(176, 218, 185));">Total: <?php echo $request_rej ?></b>
            </div>
        </div>
    </div>
</body>
