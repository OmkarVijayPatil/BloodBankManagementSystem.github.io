...
<nav class="navbar navbar-expand-lg navbar-dark " style="background: linear-gradient(to right, rgb(0, 176, 155), rgb(150, 201, 61));">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="login.php"style="border-radius: 4px; font-size: 16px;">Patient</a>
            </li>
            </ul>
        </div>
    </nav>
        ...
        <div class="row" style="margin-top: 7%;">
            <div class="col-md-4 mx-auto" id="login-container">
                ...
                <form action="" method="POST">
                    ...
                    <input type="submit" class="btn " value="Login" name="login"  style="background: linear-gradient(to right, rgb(0, 176, 155), rgb(150, 201, 61));; border:linear-gradient(to right, rgb(0, 176, 155), rgb(150, 201, 61));">
